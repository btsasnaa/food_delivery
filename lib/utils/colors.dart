...
class AppColors {
  ...
  // static const Color mainColor = const Color(0xFFfa7752);
  static const Color iconColor1 = const Color(0xFFffd28d);
  static const Color iconColor2 = const Color(0xFFfcab88);
  static const Color paraColor = const Color(0xFFbf837f);
  static const Color buttonBackgroudColor = const Color(0xFFf7f6f4);
